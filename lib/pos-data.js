// POS System - Professional Data Layer v3.0
...
export const ROLES = {
  admin: {
    label: 'Admin',
    permissions: ['kassa', 'keuken', 'bestellingen', 'menubeheer', 'dagafsluiting', 'personeel', 'financieel', 'audit', 'void', 'discount_high', 'kasboek', 'settings'],
  },
  manager: {
    label: 'Manager',
    permissions: ['kassa', 'keuken', 'bestellingen', 'menubeheer', 'dagafsluiting', 'financieel', 'void', 'discount_high', 'kasboek'],
  },
  kassier: {
    label: 'Kassier',
